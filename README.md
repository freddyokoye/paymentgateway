...
````shell
 "repositories": [
        {
            "type": "vcs",
            "url": "https://github.com/freddyokoye/paymentgateway"
        }
    ],
````
...
````shell
composer require freddyokoye/paymentgateway 
````
...
> use Version 4.x for laravel 12
> all payment gateway is now support v2/v3/v4
...
```php
 public function payment(Request $request)
    {
         return VodiaPaymentGateway::payfast()->charge_customer([ 
            ...
            'track' => 'dddshhdggt', // a random number to keep track of your payment 
            ...
            'email' => 'vhodiamulta@gmail.com', // user email
            'name' => 'freddy okoye', // user name
...
```php
    ...
    {
        dd(VodiaPaymentGateway::payfast()->ipn_response());
    }
 ```
...
[Checkout Paytm Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/paytm/)

Here is Test Credentials For Paytm
````dotenv
PAYTM_ENVIRONMENT=local // local|production
PAYTM_MERCHANT_ID=Global98573492346567
PAYTM_MERCHANT_KEY="Vodiahklmnw&ypplN"
...
$paytm = VodiaPaymentGateway::paytm();
$paytm->setMerchantId('Global98573492346567');
$paytm->setMerchantKey('Vodiahklmnw&ypplN');
...
[Checkout CinetPay Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/cinetpay/)
...
#### charge_customer method example
```php
$cinetpay = VodiaPaymentGateway::cinetpay();
...
[Checkout Paypal Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/paypal/)
...
$paypal = VodiaPaymentGateway::paypal();
...
[Checkout Stripe Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/stripe/)
...
#### charge_customer method example
```php
$stripe = VodiaPaymentGateway::stripe();
...
[Checkout Midtrans Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/midtrans/)
...
#### charge_customer method example
```php
$midtrans = VodiaPaymentGateway::midtrans();
...
[Checkout Razorpay Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/razorpay/)
...
$razorpay = VodiaPaymentGateway::razorpay();
...
## Mollie
[Checkout Mollie Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/mollie/)
...
$mollie = VodiaPaymentGateway::mollie();
...
[Checkout Flutterwave Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/flutterwave/)
...
$flutterwave = VodiaPaymentGateway::flutterwave();
...
[Checkout Paystack Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/paystack/)
...
$paystack = VodiaPaymentGateway::paystack();
...
## Payfast
[Checkout Payfast Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/payfast/)
...
$payfast = VodiaPaymentGateway::payfast();
...
## Cashfree
[Checkout Cashfree Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/cashfree/)
...
#### charge_customer method example 
```php
$cashfree = VodiaPaymentGateway::cashfree();
...
## Instamojo
[Checkout Instamojo Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/instamojo)
...
#### charge_customer method example
```php
$instamojo = VodiaPaymentGateway::instamojo();
...
[Checkout Mercadopago Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/mercadopago/)
...
#### charge_customer method example
```php
$marcadopago = VodiaPaymentGateway::marcadopago();
...
[Checkout Squareup Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/how-to-get-square-payment-gateway-api-credentials/)
...
#### charge_customer method example
```php
$squareup = VodiaPaymentGateway::squareup();
...
[Checkout PayTabs Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/how-to-get-paytabs-payment-gateway-api-credentials/)
...
#### charge_customer method example
```php
$paytabs = VodiaPaymentGateway::paytabs();
...
[Checkout BillPlz Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/how-to-setup-api-for-billplz-payment-gateway/)
...
#### charge_customer method example
```php
$billplz = VodiaPaymentGateway::billplz();
...
[Checkout Zitopay Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/zitopay-payment-gateway-setup)
...
#### charge_customer method example
```php
$zitopay = VodiaPaymentGateway::zitopay();
...
[Checkout Toyyibpay Setup Documentation](https://docs.docs.vhodia.com/docs/payment-gateway-settings/toyyibpay-payment-gateway-setup)
```php
...
#### charge_customer method example
```php
$toyyibpay = VodiaPaymentGateway::toyyibpay();
...
## Setup For Pagali
[Checkout Pagali Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/pagali-payment-gateway-setup)
```php
...
#### charge_customer method example
```php
$pagali = VodiaPaymentGateway::pagalipay();
$pagali->setPageId('');
$pagali->setEntityId('');
...
[Checkout Authorize.nnt Setup Documentation](https://docs.vhodia.com/docs/payment-gateway-settings/authorize-payment-gateway-setup)
```php
...
$authorize = VodiaPaymentGateway::authorizenet();
...
```php
    $authorizenet = VodiaPaymentGateway::authorizenet();
